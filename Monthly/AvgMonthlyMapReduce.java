...
public class AvgMonthlyMapReduce {

	public static void main(String[] args) throws IOException {
		JobConf conf = new JobConf(AvgMonthlyMapReduce.class);
		...
		conf.setMapperClass(AvgMonthlyMapper.class);
		conf.setReducerClass(AvgMonthlyReducer.class);
