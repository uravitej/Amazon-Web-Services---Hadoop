...
public class AvgMonthlyMapper extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>{
	...
	public void map(LongWritable key, Text value,
		...
		if(StringUtils.isNumeric(dataPart)){
			...
			output.collect(new Text(dataPart),new Text(temp + "," + precp + "," + wind));
		}
	}
