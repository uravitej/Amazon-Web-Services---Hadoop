...
public class ClimateMapReduce {

	public static void main(String[] args) throws IOException {
		long startTime = System.currentTimeMillis();
		   
		JobConf conf = new JobConf(ClimateMapReduce.class);
		...
		conf.setMapperClass(ClimateMapper.class);
		conf.setReducerClass(ClimateReducer.class);
